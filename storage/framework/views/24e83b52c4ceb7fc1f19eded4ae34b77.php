    ...
    <div class="container mt-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e($cancion->link_video); ?>" target="_blank">Ver Video</a></td>
                                <td>
                ...
                <form action="<?php echo e(route('canciones.guardarDatosYouTube')); ?>" method="POST" id="guardarDatosYoutubeForm">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="youtubePublishedAt" value="<?php echo e($youtubePublishedAt); ?>">
                    <input type="hidden" name="youtubeViewCount" value="<?php echo e($youtubeViewCount); ?>">
                    <input type="hidden" name="youtubeLikeCount" value="<?php echo e($youtubeLikeCount); ?>">
    ...
    <div class="card mt-4">
        ...
        <script>
            ...
            new Chart(ctxRitmo, {
                type: 'bar',
                data: {
                    labels: <?php echo json_encode($ritmos_labels); ?>, 
                    datasets: [{
                        label: 'Cantidad de Videos',
                        data: <?php echo json_encode($ritmos_data); ?>, 
    ...
    new Chart(ctxVistas, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: <?php echo json_encode($ritmos_vistas_data); ?>, 
    ...
    new Chart(ctxLikes, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: <?php echo json_encode($likes_acumulados_data); ?>, 
                backgroundColor: 'rgba(75, 192, 192, 0.2)', 
                borderColor: 'rgba(75, 192, 192, 1)', 
                borderWidth: 1 
            }]
...
<?php /**PATH D:\xampp\htdocs\proy30\music\resources\views/grupos/estadisticas.blade.php ENDPATH**/ ?>
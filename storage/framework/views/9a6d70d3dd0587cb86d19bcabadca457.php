        ...
        <nav>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="<?php echo e(route('grupos.index', ['genero_musical' => 'folcklore boliviano'])); ?>">Folklore Boliviano</a>
...
<?php if($grupos->isNotEmpty()): ?>
<div>
    <?php $__currentLoopData = $grupos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grupo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="artist">
            <img src="<?php echo e(asset($grupo->imagen)); ?>" alt="<?php echo e($grupo->nombre); ?>" class="artist-image">
            <div class="artist-info">
                <h2><?php echo e(strtoupper($grupo->nombre)); ?></h2>
                <p><?php echo e($grupo->descripcion); ?></p>
                <p><strong>Género:</strong> <?php echo e(strtoupper($grupo->genero_musical)); ?></p>
                <div class="social-icons-buttons">
                    ...
                    <div class="buttons">
                        ...
                        <a href="https://wa.me/<?php echo e($grupo->contacto_whatsapp); ?>" target="_blank" class="btn btn-contact">CONTACTAR</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\proy30\music\resources\views/grupos/busqueda.blade.php ENDPATH**/ ?>